...
## - Create a separate R code file (plot4.R) that constructs the corresponding plot. The code file should include
...
plot4 <- function() {
  ...
  par(mfrow = c(2, 2))
  ## Create the 1st Plot with the right color and names based on Global Active Power
  plot(dateTime, data$Global_active_power, col = "black", type="l", xlab = "", ylab = "Global Active Power")
  ## Create the 2nd Plot with the right color and names based on Voltage
  plot(dateTime, data$Voltage, col = "black", type="l", xlab = "datetime", ylab = "Voltage")
  ## Create the 3rd Plot with the right color and names based on Sub_metering_1
  ...
  ## Create the 4th Plot with the right color and names based on Global Reactive Power
  plot(dateTime, data$Global_reactive_power, col = "black", type="l", xlab = "datetime", ylab = "Global_rective_power")
  dev.off()
}